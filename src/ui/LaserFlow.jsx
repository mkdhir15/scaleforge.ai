...
const LaserFlow = ({
  ...
  useEffect(() => {
    ...
    if (!gl) return; // No WebGL — container stays empty (CSS fallback gradient shows)

    // Mobile detection — skip heavy WebGL on low-end devices
    ...
    try {
      ...
      return; // WebGL creation failed — fallback
    }
